						...
						function(closeProgressbar) {
							...
							requirejs(["tw.ace33022.util.StringUtil"], function(StringUtil) {
								...
								tag = '<tr>'
										...
										+ '  <th style="text-align: center;">BIG5 (HEX)</th>'
										+ '  <th style="text-align: center;">BIG5 (DEC)</th>'
										+ '</tr>'
								thead.append(tag);
								...
								for (index = 0; index <= content.length - 1; index++) {
									...
									tag = '<tr>'
											...
											+ '  <td style="text-align: center;">' + parseInt((StringUtil.encodeUTF8ToBig5(encodeURI(content[index]))).replace(/%/g, ''), 16) + '</td>'
											+ '</tr>';
									tbody.append(tag);
								}
